...
export const Footer = () => {
  return (
      <div style={{ position:'fixed', bottom:'0', width: '100%', backgroundColor: 'black', color: 'white', display: 'flex'}}>
          <div style={{ color: 'white', textAlign:'center', marginLeft:'40%' }}>@author pavan_amajala</div>
          <div style={{position: 'absolute', right: '0', width: '250px', display: 'flex', justifyContent: 'space-between'}}>
